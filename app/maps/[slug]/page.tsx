...
import { getAggregateBySlug, getAggregatesByKind } from "../../../lib/site/projection";

export function generateStaticParams() {
  return getAggregatesByKind("research_map").map((aggregate) => ({
    slug: "slug" in aggregate.unit ? aggregate.unit.slug : "",
  }));
}
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `https://silan.dev/maps/${aggregate.unit.slug}` },
  };
}
